...
import (
	...
	"github.com/Sam12121/package-scanner/sbom"
	"github.com/Sam12121/package-scanner/scanner/router"
	"github.com/Sam12121/package-scanner/tools"
	"github.com/Sam12121/package-scanner/utils"
	containerdRuntime "github.com/Sam12121/vessel/containerd"
	crioRuntime "github.com/Sam12121/vessel/crio"
	dockerRuntime "github.com/Sam12121/vessel/docker"
	podmanRuntime "github.com/Sam12121/vessel/podman"
	vc "github.com/Sam12121/vessel/utils"
...
var (
	...
	consoleURL          = flag.String("console-url", "", "Toae Management Console URL")
	consolePort         = flag.Int("console-port", 443, "Toae Management Console Port")
	vulnerabilityScan   = flag.Bool("vulnerability-scan", false, "Publish SBOM to Toae Management Console and run Vulnerability Scan")
	toaeKey        = flag.String("toae-key", "", "Toae key for auth")
